...
public class MainActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        View main_d_m_cm=findViewById(R.id.d_m_cm);
        View main_d_pm=findViewById(R.id.d_pm);
        View main_d_lm=findViewById(R.id.d_lm);
        ...
        main_d_m_cm.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                String input=editText.getText().toString();
                double ft=(Double.valueOf(input))*100;
                double m=(Double.valueOf(input))/100;
                editText.setText(input+"米="+ft+"厘米;"+input+"厘尺="+m+"米");
            }
        });

        main_d_pm.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                String input=editText.getText().toString();
                double ft=(Double.valueOf(input))*10000;
                double m=(Double.valueOf(input))/10000;
                editText.setText(input+"平方米="+ft+"平方厘米;"+input+"平方厘米="+m+"平方米");
            }
        });

        main_d_lm.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                String input=editText.getText().toString();
                double ft=(Double.valueOf(input))*1000000;
                double m=(Double.valueOf(input))/1000000;
                editText.setText(input+"立方米="+ft+"立方厘米;"+input+"立方厘尺="+m+"立方米");
            }
        });
        ...
        main_d_kg.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                String input=editText.getText().toString();
                double bang=(Double.valueOf(input))*1000;
                double kg=(Double.valueOf(input))/10000;
                editText.setText(input+"千克="+bang+"克;"+input+"克="+kg+"千克");
